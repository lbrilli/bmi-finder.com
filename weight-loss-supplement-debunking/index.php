...
<html lang="en">
	<head>
		...
		<!-- Header Meta Tags -->
		<title>Why you shouldn’t use weight loss supplements</title>
	...
	<body id="body">
		<div>
			...
			<div id="content">
				...
				<div class="content-inner">
					<div class="section minor">
						<h3 class="subtitle-minor">Myth 2: Appetite Suppressants Make You Lose Weight Effortlessly:</h3>
						<p class="subtext-minor">There are many appetite suppressants on the market, some relying on stimulants such as yohimbine or guarana, both of which cause jitters, anxiety and, in some cases, more serious side effects. Healthy eating and smart portion control are the only ways to actually suppress your appetite.					
						</p>
					</div>
					<hr/>
				</div>
				<div class="content-inner">
					<div class="section minor">
						<h3 class="subtitle-minor">Myth 3: Carb Blockers Stop Carbohydrate Absorption:</h3>
						<p class="subtext-minor">Carb blockers are relatively benign supplements. Their idea is sound, but they don’t live up to their promises. They can slow some carbohydrate absorption, but it is negligible, and you are likely to experience GI symptoms. You do, after all, need to eat carbs.
						</p>
					</div>
					<hr/>
				</div>
				<div class="content-inner">
					<div class="section minor">
						<h3 class="subtitle-minor">Myth 4: Natural = Safe:</h3>
						<p class="subtext-minor"> ‘Natural’ doesn’t mean safe. Plenty of ‘natural’ supplements can interact with your medications, have unknown side effects or be tainted. You should always discuss any supplement with your doctor, even if it is ‘natural’. 
						</p>
					</div>
					<hr/>
				</div>
				<div class="content-inner">
					<div class="section minor">
						<h3 class="subtitle-minor">Be Wary of Promises That Sound Too Good to Be True:</h3>
						<p class="subtext-minor">If you see a promise from a weight-loss supplement of ‘rapid weight loss without effort’, you can be pretty sure it’s bogus. Testimonials and celebrity endorsements aren't scientific evidence. Beware of products marketed online with aggressive tactics like limited-time offers or unrealistic guarantees.
						</p>
					</div>
					<hr/>
				</div>
				<div class="content-inner">
					<div class="section minor">
						<h3 class="subtitle-minor">Do Your Own Research and Talk to Your Doctor:</h3>
						<p class="subtext-minor">
							<ul>
								<li>Research the science behind any supplement before buying it.</li>
								<li>Check for reputable sources, such as scientific journals and government websites.</li>
								<li>Discuss any supplements with your doctor, especially if you have other health problems or are on other medications. </li>
							</ul>
